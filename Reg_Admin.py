...
# verify input
        def verify():
            if(len(z.get())) < 5:
                messagebox.showinfo("Error","Enter Admin Id\nAdmin Id should be greater than 5 letters")
            elif (len(y.get())) < 3:
...
#label and input
        ...
        Label(text = "Library Information - Adminitrator",fg='white',font = ("Arial",13,"bold"),bg="black").place(x=300,y=220)
        Label( text="Admin ID",fg='white', font=("Arial", 13, "bold"), bg="black").place(x=100, y=260)
        Label( text="Admin - Name",fg='white', font=("Arial", 13, "bold"), bg="black").place(x=100, y=300)
        Label( text="Admin - Password",fg='white', font=("Arial", 13, "bold"), bg="black").place(x=100, y=340)
